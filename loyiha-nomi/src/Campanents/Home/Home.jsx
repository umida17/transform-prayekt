...
// Agar o'zingizni rasmlaringiz bo'lsa, ularni shu yerga import qilasiz:
    ...
    <div className="home-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <div className="clients-logos">
            ...
            <div className="logos-grid">
              {/* Logoipsum o'rniga haqiqiy logolarni qo'yishingiz mumkin */}
        ...
        <div className="hero-image-wrapper">
          {/* Rasm atrofidagi noodatiy chiziqlar (accent decoration) uchun */}
